...
images_dir = '/notebooks/projects/object-detection/workspace/car/data/train_set/passing_cars_trainset'
xmls_dir = '/notebooks/projects/object-detection/workspace/car/data/train_set/passing_cars_trainset'

train_ratio = .8
model_number = 1
label_map_path = f'/notebooks/projects/object-detection/workspace/car/training/model_{model_number}/label_map/label_map.pbtxt'
output_dir = f'/notebooks/projects/object-detection/workspace/car/training/model_{model_number}/data'
num_shards = 10
...
def main(_):
    ...
    image_names = [get_file_name(f) for f in glob.glob(images_dir + '**/*.jpg')]
    ...
    with open(os.path.join(output_dir + 'source.txt'), 'a') as fid:
        fid.write(f'images_dir : {images_dir}')
        fid.write(f'\n xmls_dir : {xmls_dir}')
        fid.write(f'\n num_train : {num_images}\n train_ratio : {train_ratio}')
    
    #define output path
    train_output_path = os.path.join(output_dir, 'train.record')
    val_output_path = os.path.join(output_dir, 'validate.record')
