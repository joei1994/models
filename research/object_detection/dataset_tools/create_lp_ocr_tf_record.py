...
flags = tf.app.flags
flags.DEFINE_string('images_dir', '/notebooks/projects/object-detection/workspace/license-plate-ocr/data/images', 'Path to images directory')
flags.DEFINE_string('xmls_dir', '/notebooks/projects/object-detection/workspace/license-plate-ocr/data/annotation/xmls', 'Path to annotation directory')
flags.DEFINE_string('label_map_path', '/notebooks/projects/object-detection/workspace/license-plate-ocr/training/label_map/license_plate_ocr_label_map.pbtxt', 'Path to label_map file')
flags.DEFINE_string('output_dir', '/notebooks/projects/object-detection/workspace/license-plate-ocr/data/tf_record', 'Path to output file')
...
def main(_):
    ...
    #define output path
    train_output_path = os.path.join(FLAGS.output_dir, 'lp_ocr_train.record')
    val_output_path = os.path.join(FLAGS.output_dir, 'lp_ocr_val.record')
